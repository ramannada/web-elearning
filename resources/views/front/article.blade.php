    ...
    <article>
        <div class="row">
            ...
            <div class="col-sm-6 col-md-8">
                ...
                <h4><a href="{{ route('article.detail', ['article' => $data->slug]) }}">{{ $data->title }}</a></h4>
                ...
                <a href="{{ route('article.detail', ['article' => $data->slug]) }}" class="btn btn-default btn-sm float-right">More ... </a>
                <section>
